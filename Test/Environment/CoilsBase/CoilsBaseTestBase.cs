...
{
    public abstract class CoilsBaseTestBase : ParahumanTest
    {
        // Baron Blade's character card stays in play as a 40 HP non-environment
        // target (the highest, unless a test says otherwise).
        protected void SetupCoilsBaseGame()
        {
            SetupGameController("BaronBlade", "Legacy", "Bunker", "Haka", "Jp.ParahumansOfTheWormverse.CoilsBase");
            StartGame();
            RemoveVillainCards();
