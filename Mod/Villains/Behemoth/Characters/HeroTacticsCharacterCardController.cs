    ...
    public class HeroTacticsCharacterCardController : BehemothUtilityCharacterCardController
    {
        ...
        public override void AddSideTriggers()
        {
            ...
            if (!base.Card.IsFlipped)
            {
                ...
                base.AddSideTrigger(AddStartOfTurnTrigger((TurnTaker tt) => tt.Is(this).Hero() && !tt.IsIncapacitatedOrOutOfGame, SkipTurnOptionResponse, new TriggerType[] { TriggerType.SkipTurn, TriggerType.ModifyTokens }));
