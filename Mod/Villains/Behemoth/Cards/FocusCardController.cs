...
namespace Jp.ParahumansOfTheWormverse.Behemoth
{
    public class FocusCardController : MovementCardController
    {
        ...
        public override IEnumerator Play()
        {
            ...
            IEnumerator findCoroutine = base.GameController.FindTargetWithHighestHitPoints(1, (Card c) => c.Is(this).Hero().Target().Character(), highest, cardSource: GetCardSource());
