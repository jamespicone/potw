...
namespace Jp.ParahumansOfTheWormverse.Behemoth
{
    public class RoarCardController : BehemothUtilityCardController
    {
        ...
        public override IEnumerator Play()
        {
            ...
            IEnumerator damageCoroutine = base.GameController.DealDamage(DecisionMaker, base.CharacterCard, (Card c) => c.Alignment(this).NonVillain().Target(), 2, GetBehemothDamageType(), cardSource: GetCardSource());
            if (UseUnityCoroutines)
            {
