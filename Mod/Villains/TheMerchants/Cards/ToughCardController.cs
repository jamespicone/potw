...
namespace Jp.ParahumansOfTheWormverse.TheMerchants
{
    public class ToughCardController : TheMerchantsUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddEndOfTurnTrigger((TurnTaker tt) => tt == base.TurnTaker, (PhaseChangeAction pca) => DealDamageToHighestHP(base.Card, 1, (Card c) => c.Alignment().Hero().Target(), (Card c) => 2, DamageType.Melee, numberOfTargets: () => 2), TriggerType.DealDamage);
            base.AddTriggers();
        }
    }
}
