...
namespace Jp.ParahumansOfTheWormverse.TheMerchants
{
    public class NotExactlySanitaryCardController : TheMerchantsUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger<DealDamageAction>((DealDamageAction dda) => dda.DamageSource != null && dda.DamageSource.IsCard && dda.DamageSource.Alignment(this).Villain().Target() && dda.Target != null && dda.Target != dda.DamageSource.Card && dda.DidDealDamage && dda.DamageType != DamageType.Toxic, ToxicDamageResponse, TriggerType.DealDamage, TriggerTiming.After);
            base.AddTriggers();
        }
