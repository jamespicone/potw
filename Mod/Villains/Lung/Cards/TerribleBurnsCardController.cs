    ...
    public class TerribleBurnsCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger<DealDamageAction>(
                dda => dda.DamageType == DamageType.Fire && dda.Target.Is(this).Hero().Target().Character() && dda.DamageSource.Card == CharacterCard && dda.DidDealDamage,
            ...
            AddDealDamageAtEndOfTurnTrigger(TurnTaker, CharacterCard, c => c.Is(this).Hero().Target() && c.IsInPlay, TargetType.HighestHP, Game.H - 2, DamageType.Fire);
        }

        public IEnumerator RespondToFireDamage()
        {
            var e = GameController.SelectAndDestroyCard(DecisionMaker, new LinqCardCriteria(c => c.Is(this).Hero() && (c.Is(this).Ongoing() || c.Is(this).Equipment())), optional: false, responsibleCard: Card, cardSource: GetCardSource());
