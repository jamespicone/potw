...
namespace Jp.ParahumansOfTheWormverse.BrocktonBay
{
    public class PRTSquadCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddDealDamageAtEndOfTurnTrigger(base.TurnTaker, base.Card, (Card c) => !c.IsEnvironmentTarget, TargetType.LowestHP, 2, DamageType.Projectile, highestLowestRanking: 1, numberOfTargets: 1);
            base.AddTriggers();
        }
    }
}
