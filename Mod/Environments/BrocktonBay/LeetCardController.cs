...
namespace Jp.ParahumansOfTheWormverse.BrocktonBay
{
    public class LeetCardController : DuoCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddDealDamageAtEndOfTurnTrigger(base.TurnTaker, base.Card, (Card c) => c.Alignment().NonEnvironment().Target(), TargetType.LowestHP, 2, DamageType.Lightning, highestLowestRanking: 1, numberOfTargets: 1);
