...
namespace Jp.ParahumansOfTheWormverse.Tattletale
{
    public class ConstantSmileCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddDealDamageAtStartOfTurnTrigger(base.TurnTaker, base.CharacterCard, (Card c) => !c.IsHero && base.GameController.IsCardVisibleToCardSource(c, GetCardSource()), TargetType.All, 1, DamageType.Psychic);
            base.AddTriggers();
        }
    }
}
